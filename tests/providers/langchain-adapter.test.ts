...
import { createLangChainAdapter, LangChainAdapter } from "../../src/providers/adapters/langchain-adapter.js";
...
describe("LangChain Adapter", () => {
  ...
  describe("createRunnable", () => {
    it("should create a runnable that can be called", async () => {
      ...
      try {
        ...
        expect((error as Error).message).toContain("LangChain core runnables not available");
      }
    });
  });
  ...
  describe("createDocumentTransform", () => {
    it("should create a document transform class", async () => {
      ...
      try {
        ...
        expect((error as Error).message).toContain("LangChain core documents not available");
      }
    });
  });
  ...
  describe("configuration updates", () => {
    it("should allow config updates", () => {
      const adapter = createLangChainAdapter({ policies: ["EMAIL_ADDRESS"] as PolicyName[] });

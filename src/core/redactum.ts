...
const PRIORITY_MAP: Record<PolicyCategory, number> = {
  ...
  [PolicyCategory.CREDIT_CARD]: 6,
  [PolicyCategory.EMAIL]: 7,
  [PolicyCategory.PHONE]: 8,
  [PolicyCategory.SSN]: 9,
  [PolicyCategory.GOVERNMENT_ID]: 10,
  [PolicyCategory.TAX_IDENTIFIER]: 11,
  [PolicyCategory.INSURANCE]: 12,
  [PolicyCategory.MEDICAL]: 13,
  [PolicyCategory.FINANCIAL]: 14,
  [PolicyCategory.DIGITAL_IDENTITY]: 15,
  [PolicyCategory.DEV_IDENTIFIER]: 16,
  [PolicyCategory.IP_ADDRESS]: 17,
  [PolicyCategory.DATE_OF_BIRTH]: 18,
  [PolicyCategory.VEHICLE]: 19,
  [PolicyCategory.EMPLOYEE_ID]: 20,
  [PolicyCategory.ADDRESS]: 21,
  [PolicyCategory.GEOGRAPHIC]: 22,
  [PolicyCategory.PERSON_NAME]: 23,
  [PolicyCategory.CLOUD_CREDENTIALS]: 24,
  [PolicyCategory.CI_CD_SECRETS]: 25,
  [PolicyCategory.PACKAGE_REGISTRY]: 26,
  [PolicyCategory.MONITORING_SECRETS]: 27,
  [PolicyCategory.AUTH_SECRETS]: 28,
  [PolicyCategory.MESSAGING_SECRETS]: 29,
  [PolicyCategory.WEBHOOK_URLS]: 30,
  [PolicyCategory.ENCRYPTION_KEYS]: 31,
  [PolicyCategory.CONTAINER_REGISTRY]: 32,
  [PolicyCategory.INFRASTRUCTURE_SECRETS]: 33,
  [PolicyCategory.CUSTOM]: 34,
};

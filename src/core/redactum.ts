...
const PRIORITY_MAP: Record<PolicyCategory, number> = {
  ...
  [PolicyCategory.CLOUD_CREDENTIALS]: 23,
  [PolicyCategory.CI_CD_SECRETS]: 24,
  [PolicyCategory.PACKAGE_REGISTRY]: 25,
  [PolicyCategory.MONITORING_SECRETS]: 26,
  [PolicyCategory.AUTH_SECRETS]: 27,
  [PolicyCategory.MESSAGING_SECRETS]: 28,
  [PolicyCategory.WEBHOOK_URLS]: 29,
  [PolicyCategory.ENCRYPTION_KEYS]: 30,
  [PolicyCategory.CONTAINER_REGISTRY]: 31,
  [PolicyCategory.INFRASTRUCTURE_SECRETS]: 32,
  [PolicyCategory.CUSTOM]: 33,
};
